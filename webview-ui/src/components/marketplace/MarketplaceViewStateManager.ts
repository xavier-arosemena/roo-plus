 ...
 *
 * This class manages the state for the marketplace view in the Roo+ extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the Roo+ extensions interface
