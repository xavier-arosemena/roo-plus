...
import { type ExtensionMessage, parseExtensionMessage } from "@roo-code/types"
...
const App = () => {
	const { didHydrateState, showWelcome, settingsImportedAt, shouldShowAnnouncement, renderContext, mdmCompliant } =
		useExtensionState()
