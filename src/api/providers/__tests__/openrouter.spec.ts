...
describe("OpenRouterHandler", () => {
	...
	describe("createMessage", () => {
		...
		it("propagates API errors from the stream", async () => {
			const handler = new OpenRouterHandler(mockOptions)
		...
		it("propagates SDK exceptions thrown by createMessage", async () => {
			const handler = new OpenRouterHandler(mockOptions)
		...
		it("propagates 429 rate limit errors from the stream", async () => {
			const handler = new OpenRouterHandler(mockOptions)
	...
	describe("completePrompt", () => {
		...
		it("propagates 429 rate limit errors from the response", async () => {
			const handler = new OpenRouterHandler(mockOptions)
			const mockError = {
				error: {
