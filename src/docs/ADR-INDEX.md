...
| [Canonical `custom_modes.d/` Catalog Pipeline](adr-custom-modes-canonical-catalog.md)           | ✅ ACCEPTED | 2026-08-06 | Single canonical `custom_modes.d/` catalog (one mode per file, 290 modes) feeds `.roomodes`, `pre-installed-modes.yml`, and `modes.yml`; built-in slug guard + submodule pin (`4ee95d2`) make packaged artifacts hermetic (Issue #159)                  |
