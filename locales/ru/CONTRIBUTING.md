...
### 3. Присоединяйся к сообществу Roo+
...
- **Проверьте существующие задачи**: выполните поиск в [задачах GitHub](https://github.com/xavier-arosemena/roo-plus/issues).
...
- Создайте новую ошибку, используя [шаблон «Отчет об ошибке»](https://github.com/xavier-arosemena/roo-plus/issues/new/choose) с:
    - Четкими, пронумерованными шагами воспроизведения
    - Ожидаемым и фактическим результатом
    - Версией Roo+ (обязательно); поставщиком/моделью ИИ, если применимо
- **Проблемы с безопасностью**: сообщайте в частном порядке через [рекомендации по безопасности](https://github.com/xavier-arosemena/roo-plus/security/advisories/new).
...
Внося свой вклад, вы соглашаетесь с тем, что ваши вклады будут лицензироваться по лицензии Apache 2.0, в соответствии с лицензированием Roo+.
