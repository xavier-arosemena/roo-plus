...
Roo+ és un projecte impulsat per la comunitat i valorem profundament cada contribució. Per agilitzar la col·laboració, operem sobre una base de [primer la incidència](#enfocament-de-primera-incidència), la qual cosa significa que totes les [sol·licituds d'extracció (PR)](#enviament-duna-sollicitud-dextracció) primer han d'estar enllaçades a una incidència de GitHub. Si us plau, reviseu aquesta guia amb atenció.
...
### 3. Uneix-te a la comunitat de Roo+
...
- **Comproveu les incidències existents**: cerqueu a [Incidències de GitHub](https://github.com/xavier-arosemena/roo-plus/issues).
...
- Creeu un error nou utilitzant la [plantilla "Informe d'error"](https://github.com/xavier-arosemena/roo-plus/issues/new/choose) amb:
    - Passos de reproducció clars i numerats
    - Resultat esperat vs real
    - Versió de Roo+ (obligatori); proveïdor/model d'API si és rellevant
- **Problemes de seguretat**: informeu de manera privada a través d'[avisos de seguretat](https://github.com/xavier-arosemena/roo-plus/security/advisories/new).
...
En contribuir, accepteu que les vostres contribucions es llicenciaran sota la llicència Apache 2.0, d'acord amb la llicència de Roo+.
