...
- **मौजूदा समस्याओं की जाँच करें**: [गिटहब समस्याएँ](https://github.com/xavier-arosemena/roo-plus/issues) में खोजें।
...
- ["बग रिपोर्ट" टेम्पलेट](https://github.com/xavier-arosemena/roo-plus/issues/new/choose) का उपयोग करके एक नया बग बनाएँ:
    - स्पष्ट, क्रमांकित पुनरुत्पादन चरण
    - अपेक्षित बनाम वास्तविक परिणाम
    - Roo+ संस्करण (आवश्यक); यदि प्रासंगिक हो तो एपीआई प्रदाता/मॉडल
- **सुरक्षा समस्याएँ**: [सुरक्षा सलाहकारों](https://github.com/xavier-arosemena/roo-plus/security/advisories/new) के माध्यम से निजी तौर पर रिपोर्ट करें।
...
योगदान करके, आप सहमत हैं कि आपके योगदान अपाचे 2.0 लाइसेंस के तहत लाइसेंस प्राप्त होंगे, जो Roo+ के लाइसेंस के अनुरूप है।
