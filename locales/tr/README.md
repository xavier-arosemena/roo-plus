...
Roo+, sizin çalışma şeklinize uyum sağlar, tam tersi değil:
...
- **[Dokümantasyon](https://docs.zoocode.dev):** Roo+'u yükleme, yapılandırma ve ustalaşma konusundaki resmi kılavuz.
...
- **[GitHub Sorunları](https://github.com/xavier-arosemena/roo-plus/issues):** Hataları bildirin ve gelişimi takip edin.
- **[Özellik İstekleri](https://github.com/xavier-arosemena/roo-plus/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Bir fikriniz mi var? Geliştiricilerle paylaşın.
...
Roo+ uzantısını çalıştırmanın birkaç yolu vardır:

### Geliştirme Modu (F5)

Aktif geliştirme için VSCode'un yerleşik hata ayıklama özelliğini kullanın:

VSCode'da `F5` tuşuna basın (veya **Çalıştır** → **Hata Ayıklamayı Başlat**'a gidin). Bu, Roo+ uzantısının çalıştığı yeni bir VSCode penceresi açacaktır.
...
**Roo+'un keyfini çıkar!** Onu ister kısa tasma ile yakınında tut, ister kendi başına dolaşmasına izin ver, neler inşa edeceğini görmek için sabırsızlanıyoruz. Soruların veya özellik fikirlerin varsa bir [issue](https://github.com/xavier-arosemena/roo-plus/issues) aç ya da bir [discussion](https://github.com/xavier-arosemena/roo-plus/discussions) başlat. Mutlu kodlamalar!
