...
| ⚡ **Webview Reliability**     | Bounded task-history payloads, a payload-size SLI, and quieter consoles fix the gray frozen webview and the large-state warning (v3.88.1)      |
